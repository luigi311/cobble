...
pub const CONNECTIVITY_CHARACTERISTIC: Uuid = uuid::uuid!("00000001-328e-0fbb-c642-1aa6699bdada");
...
pub const BATTERY_LEVEL_CHARACTERISTIC: Uuid = uuid::uuid!("00002a19-0000-1000-8000-00805f9b34fb");
